...
const ProductMetadata = () => {
    ...
    const { product, selectedColor, selectedSize, itemQuantity } = useProductDetailsContext()
    const {name: pdName, description: pdDescription, reviews:pdReviews, rating: pdRating } = product
    ...
    const roundedRating = Math.round(pdRating * 10) / 10;
            ...
            <section className={clsx('flex flex-col gap-8')}>
                <div className="flex flex-col items-start">
                    ...
                    <div className={clsx('flex flex-wrap items-center gap-2', 'mt-3')}>
                        ...
                        {pdReviews > 0
                            ? (<Button 
                                    label={`See all ${pdReviews} reviews`}
                                    href='#'
                                    variant='link'
                                    className="text-sm"
                                />)
